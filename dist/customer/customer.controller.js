...
const customer_property_offer_service_1 = require("./../customer-property-offer/customer-property-offer.service");
...
let CustomerController = class CustomerController {
    ...
    constructor(customerService, PropertyService, CustomerPropertyOfferService) {
    ...
    async getPropertiesByCustomer(id) {
        return this.PropertyService.findPropertiesByCustomer(+id);
    }
    async getOffersByCustomer(id) {
...
], CustomerController.prototype, "getPropertiesByCustomer", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], CustomerController.prototype, "getOffersByCustomer", null);
exports.CustomerController = CustomerController = __decorate([
    (0, common_1.Controller)('customer'),
    __metadata("design:paramtypes", [customer_service_1.CustomerService,
        property_service_1.PropertyService,
        customer_property_offer_service_1.CustomerPropertyOfferService])
], CustomerController);
