...
let AuthCustomerController = class AuthCustomerController {
    ...
    login(input) {
        return this.authService.authenticateCustomer(input) || "not Found";
    }
    getUserInfo(request) {
        return request.user;
    }
